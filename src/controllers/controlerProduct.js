import {
  ProductService
} from "../services/serviceProduct.js";
import {
  addProductError
} from "../services/errores/errorInformation.js";
...
export const createProduct = async (req, res) => {
  try {
    ...
    if (addProduct) {
      addProduct.owner = req.user.email
...
export const updateProduct = async (req, res) => {
  try {
    ...
    if (req.user.role === "admin" || (req.user.role === "premium" && productToUpdate.owner === req.user.email)) {
      if (productToUpdate) {
